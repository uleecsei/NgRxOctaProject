...
//       return this.authService.signIn({ email: action.email, password: action.password }).pipe(
//         map((): Action => {
//           this.ngZone.run(() => {
...
//             return of(authActions.signInFailure({ newPasswordRequired: true }));
//           }
//
//           this.ngZone.run(() => {
...
//           });
//
//           return of(authActions.signInFailure({ newPasswordRequired: false }));
//         }),
//       );
//     }),
//   ));
